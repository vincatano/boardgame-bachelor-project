...
My main focus during the project was on the model of the game, particularly the [gamedata](boardgame-bachelor-project/src/main/java/it/polimi/ingsw/model/gamedata/), the [tests](boardgame-bachelor-project/src/test/java/it/polimi/ingsw/) and the [Command Line visualization](boardgame-bachelor-project/src/main/java/it/polimi/ingsw/view/cli/) of the game. I also formalized the rules of the cards so that we wouldn't need to hard-code them. We as a team decided to don't have a single project manager but we decided that we were all on the same level of decision making.
